using NNAuthorizationServer.API.Validators;
...
namespace NNAuthorizationServer.API.Infrastructure
{
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            ...
            //Configure custom validation logic for usernames
            ...
            appUserManager.EmailService = new NNAuthorizationServer.API.Services.EmailService();
