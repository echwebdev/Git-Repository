...
namespace NNAuthorizationServer.API.Controllers
{
    ...
    {
        [HttpPost]
        [Route("getRole", Name = "GetRoleById")]
        public async Task<IHttpActionResult> GetRole(GetRoleBindingModel model)
        {
        ...
        [HttpPost]
        [Route("update")]
        public async Task<IHttpActionResult> UpdateRole(UpdateRoleBindingModel model)
        {
            var role = await this.AppRoleManager.FindByIdAsync(model.Id);
        ...
        [HttpPost]
        [Route("delete")]
        public async Task<IHttpActionResult> DeleteRole(DeleteRoleBindingModel model)
        {
